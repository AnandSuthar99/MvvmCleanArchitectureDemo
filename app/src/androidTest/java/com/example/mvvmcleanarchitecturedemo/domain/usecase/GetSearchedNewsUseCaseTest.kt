...
class GetSearchedNewsUseCaseTest {
    ...
    @Test
    fun getSearchedNews_requestSent_validateResponseStatusAndTotalResults() {
        val response = runBlocking { repository.getSearchedNews("us", "sports", 1) }
